...
export function mapBoodschap(boodschap: RBoodschap): SBoodschap {
    ...
    let ontvangerCorrespondentenLimited =
    ...
    let extraOntvangerCorrespondenten = [];
...
export function mapBoodschapCorrespondent(correspondent: RBoodschapCorrespondent | undefined): SBoodschapCorrespondent | undefined {
...
export function kanReagerenOpBoodschap(boodschap: SBoodschap) {
    return !boodschap.verzondenDoorGebruiker && boodschap.verzenderCorrespondent;
}
...
export interface SBoodschap extends SEntiteit {
    ...
    verzenderCorrespondent: SBoodschapCorrespondent | undefined;
