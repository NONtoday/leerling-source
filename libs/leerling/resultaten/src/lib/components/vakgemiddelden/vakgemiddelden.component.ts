...
import { AccessibilityService, PLAATSING_COMPONENT_TABINDEX, PlaatsingenComponent, onRefresh } from 'leerling-util';
...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, PlaatsingenComponent, VakgemiddeldeItemComponent, SpinnerComponent],
