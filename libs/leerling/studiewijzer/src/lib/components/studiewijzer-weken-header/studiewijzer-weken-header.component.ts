...
import { IconBoek, IconChevronBoven, IconChevronOnder, IconDownloaden, IconFilter, IconKalenderDag, provideIcons } from 'harmony-icons';
...
@Component({
    ...
    providers: [provideIcons(IconDownloaden, IconChevronOnder, IconKalenderDag, IconFilter, IconBoek, IconChevronOnder, IconChevronBoven)]
})
